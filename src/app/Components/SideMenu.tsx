            ...
            {mobile? (
                <div className={'SideMenu_container'} style={visible? {transform: "translateX(0)"}: {transform: "translateX(65vw)"}}>
                    ...
                    <ul className='SideMenu_section'>
                        ...
                        <li className='SideMenu_option'><Link href='/servicios' onClick={onClose}><p>{language === 'ES'?'Servicios':'Services'}</p></Link></li>
                        <li className='SideMenu_option'><Link href='/neuromodulacion' onClick={onClose}><p>{language === 'ES'?'Neuromodulacion':'Neuromodulation'}</p></Link></li>
